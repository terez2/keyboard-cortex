        ...
        return new Promise(function (resolve, reject) {
            ...
            socket.on('message', (data) => {
                try {
                    ...
                    console.log('[queryHeadsetId]:', error);
                }
            })
        })
    }
...
let user = {
    "clientId": "LylN2YDoWth7egFBU4UXy0YpTh91FoJZHrewLCef",
    "clientSecret": "y7kDi4I6sUt3qeDo9cMP3yeOU4jltngobAcGDo25VQ5RStiTJrknLOsEdUrbMWmWLTOCh81l5CyOS4qBfEerp7Ea1q6CXARZKdG3TbUemd6BTTu0JiiWfhMLmGKkRuOx",
    "debit": 1
}
